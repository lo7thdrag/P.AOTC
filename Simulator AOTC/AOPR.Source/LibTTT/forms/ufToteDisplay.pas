...
procedure TfrmToteDisplay.Panel23Click(Sender: TObject);
begin
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabInjection.Color := RGB(54, 78, 85);
      pnlInjection.BringToFront;
      pnlTabInjection.Tag := 1;
      pnlTabVolume.Tag := 0;
      pnlTabVolume.Color := RGB(33, 49, 53);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabVolume.Color := RGB(54, 78, 85);
      pnlVolume.BringToFront;
      pnlTabVolume.Tag := 1;
      pnlTabInjection.Tag := 0;
      pnlTabInjection.Color := RGB(33, 49, 53);
    end;
  end;
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabExternal.Color := RGB(54, 78, 85);
      pnlExternal.BringToFront;
      pnlTabExternal.Tag := 1;
      pnlTabInternal.Tag := 0;
      pnlTabInternal.Color := RGB(33, 49, 53);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabInternal.Color := RGB(54, 78, 85);
      pnlInternal.BringToFront;
      pnlTabInternal.Tag := 1;
      pnlTabExternal.Tag := 0;
      pnlTabExternal.Color := RGB(33, 49, 53);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      pnlTabResponsibility.Color := RGB(33, 49, 53);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabResponsibility.Color := RGB(54, 78, 85);
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabAboveWater.Color := RGB(54, 78, 85);
      pnlAboveWater.BringToFront;
      pnlTabAboveWater.Tag := 1;
      pnlTabSurfaceAndSub.Tag := 0;
      pnlTabSurfaceAndSub.Color := RGB(33, 49, 53);
      pnlTabBoundaries.Tag := 0;
      pnlTabBoundaries.Color := RGB(33, 49, 53);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabBoundaries.Color := RGB(54, 78, 85);
