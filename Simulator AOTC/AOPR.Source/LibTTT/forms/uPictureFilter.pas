...
//  PageControl1.TabIndex := 0;
  ...
  pnlTabGeneral.Tag := 0;
  pnlTabNone.Tag := 0;
  pnlTabAir.Color := RGB(33, 49, 53);
  pnlTabSurface.Color := RGB(33, 49, 53);
  pnlTabSubsurface.Color := RGB(33, 49, 53);
  pnlTabLand.Color := RGB(33, 49, 53);
  pnlTabGeneral.Color := RGB(33, 49, 53);
  pnlTabNone.Color := RGB(33, 49, 53);
end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabSurface.Color := RGB(54, 78, 85);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabSubsurface.Color := RGB(54, 78, 85);
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabGeneral.Color := RGB(54, 78, 85);
