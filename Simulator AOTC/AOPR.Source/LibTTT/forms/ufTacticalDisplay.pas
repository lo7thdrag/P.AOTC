...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabTrackTable.Color := RGB(54, 78, 85);
      pnlTrackTable.BringToFront;
      pnlTabTrackTable.Tag := 1;
      pnlTabTrackControl.Tag := 0;
      pnlTabTrackControl.Color := RGB(33, 49, 53);
    end;
  end;
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabHook.Color := RGB(54, 78, 85);
      pnlContentHook.BringToFront;
      pnlTabHook.Tag := 1;
      pnlTabDetails.Tag := 0;
      pnlTabDetection.Tag := 0;
      pnlTabIFF.Tag := 0;
      pnlTabDetails.Color := RGB(33, 49, 53);
      pnlTabDetection.Color := RGB(33, 49, 53);
      pnlTabIFF.Color := RGB(33, 49, 53);
    end;
  end
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabDetails.Color := RGB(54, 78, 85);
      pnlContentDetails.BringToFront;
      pnlTabDetails.Tag := 1;
      pnlTabHook.Tag := 0;
      pnlTabDetection.Tag := 0;
      pnlTabIFF.Tag := 0;
      pnlTabHook.Color := RGB(33, 49, 53);
      pnlTabDetection.Color := RGB(33, 49, 53);
      pnlTabIFF.Color := RGB(33, 49, 53);
    end;
  end
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabDetection.Color := RGB(54, 78, 85);
...
begin
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabOwnShip.Color := RGB(54, 78, 85);
      ...
      pnlTabPlatformGuidance.Color := RGB(33, 49, 53);
      pnlTabCounterMeasure.Color := RGB(33, 49, 53);
      pnlTabWeapon.Color := RGB(33, 49, 53);
      pnlTabSensor.Color := RGB(33, 49, 53);
      pnlTabEMCON.Color := RGB(33, 49, 53);
      pnlTabFireControl.Color := RGB(33, 49, 53);
    end;
  end
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabPlatformGuidance.Color := RGB(54, 78, 85);
      ...
      imgEMCON.Tag := 0;
      imgFireControl.Tag := 0;
      pnlTabOwnShip.Color := RGB(33, 49, 53);
      pnlTabCounterMeasure.Color := RGB(33, 49, 53);
      pnlTabWeapon.Color := RGB(33, 49, 53);
      pnlTabSensor.Color := RGB(33, 49, 53);
      pnlTabEMCON.Color := RGB(33, 49, 53);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabCounterMeasure.Color := RGB(54, 78, 85);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabWeapon.Color := RGB(54, 78, 85);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabSensor.Color := RGB(54, 78, 85);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabEMCON.Color := RGB(54, 78, 85);
  ...
  begin
    if ImgTag = 0 then
    begin
      pnlTabFireControl.Color := RGB(54, 78, 85);
...
begin
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabPlatform.Color := RGB(54, 78, 85);
      pnlPlatform.BringToFront;
      pnlTabPlatform.Tag := 1;
      pnlTabPosition.Tag := 0;
      pnlTabPosition.Color := RGB(33, 49, 53);
    end;
  end;
  ...
  begin
    if PanelTag = 0 then
    begin
      pnlTabPosition.Color := RGB(54, 78, 85);
      pnlPosition.BringToFront;
      pnlTabPosition.Tag := 1;
      pnlTabPlatform.Tag := 0;
      pnlTabPlatform.Color := RGB(33, 49, 53);
    end;
  end;
end;
